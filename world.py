...
def Test(data, **kwargs):
    self = World(data, "Monde1", "assets/maps/village2.txt")
...
def Test2(data, **kwargs):
        self = World(data, "Monde2", "assets/maps/testchateau.txt")
...
def Test3(data, **kwargs):
    self = World(data, "Monde3", "assets/maps/test_village.txt")
